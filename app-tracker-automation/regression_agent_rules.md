...
- **Regression Target Identification**: Read the requested target (e.g., a specific folder `tests/regression/`, a pytest marker `@pytest.mark.regression`, or a suite file).
- **Target Verification**: 
...
- **Execution**: Run the specific pytest command for the locked target (e.g., `python -m pytest <path_to_suite>`).
