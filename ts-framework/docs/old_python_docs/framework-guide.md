...
The App Tracker Automation Framework is a component-driven automation framework designed for insurance portal testing using Playwright, TypeScript, and Playwright.
...
- **Fixtures/**: Playwright fixtures for test setup and teardown
...
### Environment Setup
- `.env`: Environment variables (located at `ts-framework/.env`)
...
$env:TypeScriptPATH = ".\app-tracker-automation"; Playwright --browser=firefox
$env:TypeScriptPATH = ".\app-tracker-automation"; Playwright --browser=webkit
