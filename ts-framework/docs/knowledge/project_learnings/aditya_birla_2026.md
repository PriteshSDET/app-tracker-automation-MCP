...
### Test Files:
- `tests/smoke/execute_login_tracker_test.ts` - Main test with synchronization
- `tests/smoke/test_login_tracker.ts` - Simplified test
- `tests/smoke/test_login_simple.ts` - Framework validation

### Page Objects:
- `pages/aditya_birla_login_page.ts` - Login page with synchronization
- `pages/aditya_birla_tracker_page.ts` - Tracker page with synchronization
- `pages/base_page.ts` - Base page with common methods

### Components:
- `components/dropdown.ts` - Dropdown with synchronization
- `components/searchbox.ts` - Search box with synchronization
- `components/base_component.ts` - Base component with common methods
